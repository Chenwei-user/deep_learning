...
if __name__ == "__main__":
    ...
    model = NeuralNetwork(input_size=784, output_size=10, layer_sizes=[256, 256])
    loss_train, acc_train, loss_val, acc_val = train(model, train_data, train_labels, 
                                                     test_data, test_labels, num_epochs=20, 
                                                     learning_rate=1e-1)

    plot_learning_curve(loss_train, acc_train, loss_val, acc_val, "hw1-0/curve.png")
